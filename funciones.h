...
do{
	...
	case 7: {panta1();mayus();break;}
	case 8: {invertir(invert);break;}
	case 9: {raiz();break;}
	case 10: {arvo(pi,rd);break;}  
	case 11: {can();break;}
	case 12: {concat(cc1,cc2);break;}
	case 13: return main();break;
	default : system("cls");gt(25,15);co "DIGITE DE 1 A 13";gt(1,25)system("pause");system("cls");
}
   }while(opc!=13);
}
...
float inver(float r,float n1){              //FUNCIÓN FLOAT CON PARAMETROS 
	...
	r=1/n1;
	gt(3,11+i)co i<<") "<<" EL INVERSO DE: "<<n1<<" ES: "<<r;
}
gt(1,25)system("pause");
}
...
double raiz(){                              //FUNCIÓN DOUBLE SIN PARAMETROS
		panta1();
		gt(5,7)cout<<"Digite la cantidad de ra"<<char(161)<<"ces que desea realizar:  ";cin>>  n;
for(int i=1;i<=n;i++){
